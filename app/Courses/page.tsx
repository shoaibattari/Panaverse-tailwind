          ...
          <div className="mx-auto mt-1 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
            <dl className="">
              {cards.map((ele) => (
                <div
                  key={ele.id}
                  className=" rounded-lg mt-5 px-3 bg-gray-50 py-10 text-center ring-1 ring-inset ring-gray-900/5 duration-700 hover:cursor-pointer hover:scale-75  translate-y-3 -skew-x-3	"
                >
